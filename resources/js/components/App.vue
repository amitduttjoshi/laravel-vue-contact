<template>
  <div>
    <div class="mainWrapper h-screen bg-white">
      <div class="flex flex-row">
        <div class="leftSidebar bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
          <!-- Logo -->
          <nav class="pt-4">
            <router-link to="/">
              <svg
                class="fill-current text-blue-600 pl-2 w-12"
            ...
            <p class="pt-12 px-2 font-bold text-gray-500 uppercase text-xs">
              Create
              <router-link class="flex items-center w-full py-2" to="/contacts/create">
                <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-3 h-3">
                  <path
                ...
                <div class="tracking-wide pl-2 text-xs text-blue-500 hover:text-gray-900">Add New</div>
              </router-link>
            </p>
            <p class="pt-12 px-2 font-bold text-gray-500 uppercase text-xs">
              General
              <router-link class="flex items-center w-full py-2" to="/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  class="fill-current text-blue-600 w-3 h-3"
                >
                  <path
                    class="st0"
                ...
                <div class="tracking-wide pl-2 text-xs text-blue-500 hover:text-gray-900">Contacts</div>
              </router-link>
              <router-link class="flex items-center w-full py-2" to="/">
                <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-3 h-3">
                  <path
                ...
                <div class="tracking-wide pl-2 text-xs text-blue-500 hover:text-gray-900">Birthday</div>
              </router-link>
            </p>
            <p class="pt-12 px-2 font-bold text-gray-500 uppercase text-xs">
              Settings
              <router-link class="flex items-center w-full py-2" to="/logout-user">
                <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-3 h-3">
                  <path
                ...
                <div class="tracking-wide pl-2 text-xs text-blue-500 hover:text-gray-900">Logout</div>
              </router-link>
            </p>
          </nav>
          <!-- Logo -->
